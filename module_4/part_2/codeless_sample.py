...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_id("id_registration-email").send_keys("fhsjbuivxncvsdnfgs@mail.ru")
        driver.find_element_by_id("id_registration-password1").click()
        driver.find_element_by_id("id_registration-password1").clear()
        driver.find_element_by_id("id_registration-password1").send_keys("Test12345")
        driver.find_element_by_id("id_registration-password2").click()
        driver.find_element_by_id("id_registration-password2").clear()
        driver.find_element_by_id("id_registration-password2").send_keys("Test12345")
        driver.find_element_by_name("registration_submit").click()
        driver.find_element_by_xpath("//div[@id='messages']/div/div").click()
